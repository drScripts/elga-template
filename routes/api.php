...
Route::prefix('versions')->group(function() {
    Route::get('/', [Controller::class, 'getVersions']);
    Route::post('/', [Controller::class, 'createVersion']);
    Route::get('/{id}', [Controller::class, 'getVersionById']);
    Route::patch('/{id}', [Controller::class, 'updateVersion']);
    Route::delete('/{id}', [Controller::class, 'deleteVersion']);
});
